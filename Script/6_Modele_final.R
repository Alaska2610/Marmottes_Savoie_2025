...
# lambda_all_obsprim <- cbind(mean_lambdaN[559:1112,], CI_lambdaN[559:1112,], nb_obs=y_tot[,1], site.covs_tot)
# lambda_all_obsprim$observateur <- "primaire"
# lambda_all_obssec <- cbind(mean_lambdaN[1095:1638,], CI_lambdaN[1095:1638,], nb_obs=y_tot[,"obs_sec"], site.covs_tot)
