...
samples.mperiodeP$p_waic <- samples.mperiodeP$WAIC
samples.mperiodeP$waic <- samples.mperiodeP$deviance + samples.mperiodeP$p_waic
tmp <- sapply(samples.mperiodeP, sum)
waic.mperiodeP <- round(c(waic = tmp[["waic"]], p_waic = tmp[["p_waic"]]),1)
waic.mperiodeP
# waic : 1089.8
